...
<!-- 				<a data-bs3-grid-builder-switcher="editor" class="<?php echo esc_attr( $editor_class ); ?>" href="#!" id="wp-editor-btn"><?php _e( 'Classic Editor', 'bs3-grid-builder' ); ?></a> -->
				<a data-bs3-grid-builder-switcher="builder" class="<?php echo esc_attr( $builder_class ); ?>" href="#!" id="bs3-grid-builder-btn"><?php _e( 'Grid Builder', 'bs3-grid-builder' ); ?></a>
